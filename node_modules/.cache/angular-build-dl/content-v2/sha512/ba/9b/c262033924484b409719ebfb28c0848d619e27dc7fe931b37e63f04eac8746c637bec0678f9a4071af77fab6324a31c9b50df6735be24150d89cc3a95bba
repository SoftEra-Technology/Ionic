...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWritableDatabase", function() { return getWritableDatabase; });
...
let getWritableDatabase = class getWritableDatabase {
    constructor(sqlite, 
...
getWritableDatabase.ctorParameters = () => [
    { type: _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_2__["SQLite"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] }
];
getWritableDatabase = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataBaseHelper", function() { return DataBaseHelper; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/sqlite/ngx */ "./node_modules/@ionic-native/sqlite/ngx/index.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
let DataBaseHelper = class DataBaseHelper {
    ...
    constructor(platform, sqlite) {
        ...
        this.USER_TB = "CREATE TABLE USER_TB(_id integer primary key autoincrement,EMP_ID text not null," +
        ...
        this.AUDIT_TB = "CREATE TABLE AUDIT_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.SECTION_TB = "CREATE TABLE SECTION_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_TB = "CREATE TABLE QUESTION_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_CHOICE_TB = "CREATE TABLE QUESTION_CHOICE_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_STANDARD_TB = "CREATE TABLE QUESTION_STANDARD_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_STANDARD_PREDEFINED_TB = "CREATE TABLE QUESTION_STANDARD_PREDEFINED_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_OPTION_TB = "CREATE TABLE QUESTION_OPTION_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_RANGE_TB = "CREATE TABLE QUESTION_RANGE_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.QUESTION_FIELDS_TB = "CREATE TABLE QUESTION_FIELDS_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.FIELDS_VALUE_TB = "CREATE TABLE FIELDS_VALUE_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.FIELDS_CHOICE_TB = "CREATE TABLE FIELDS_CHOICE_TB(_id integer primary key autoincrement,AUDIT_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_TB = "CREATE TABLE AUDIT_ATTEMPTED_TB(ATTEMPTED_ID integer primary key autoincrement," +
        ...
        this.AUDIT_ATTEMPTED_SECTION = "CREATE TABLE AUDIT_ATTEMPTED_SECTION(ATTEMPTED_ID integer not null,AUDIT_ID integer not null," +
            "SECTION_ID integer not null,PARENT_SECTION_ID integer not null,SECTION_NAME text not null,SECTION_DESC text not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS(ATTEMPTED_ID integer not null,AUDIT_ID integer not null," +
            "SECTION_ID integer not null,QUESTION_ID integer not null,QUESTION_TYPE_ID integer not null,QUESTION_NAME text not null," +
        ...
        this.AUDIT_ATTEMPTED_RECIVING_QUESTIONS = "CREATE TABLE AUDIT_ATTEMPTED_RECIVING_QUESTIONS(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS_CHOICE = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS_CHOICE(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS_STANDATD = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS_STANDATD(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS_STANDATD_PREDEFINED = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS_STANDATD_PREDEFINED(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS_OPTION = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS_OPTION(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTIONS_RANGE = "CREATE TABLE AUDIT_ATTEMPTED_QUESTIONS_RANGE(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTION_FIELD = "CREATE TABLE AUDIT_ATTEMPTED_QUESTION_FIELD(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTION_FIELD_VALUE = "CREATE TABLE AUDIT_ATTEMPTED_QUESTION_FIELD_VALUE(ATTEMPTED_ID integer not null," +
        ...
        this.AUDIT_ATTEMPTED_QUESTION_FIELD_CHOICE = "CREATE TABLE AUDIT_ATTEMPTED_QUESTION_FIELD_CHOICE(ATTEMPTED_ID integer not null," +
            "AUDIT_ID integer not null,SECTION_ID integer not null,QUESTION_ID integer not null,KEY_FIELD_ID integer not null,KEY_FIELD_NAME text not null," +
        ...
        this.AUDIT_ERROR_LOG = "CREATE TABLE AUDIT_ERROR_LOG(ID integer primary key autoincrement,SCREEN_NAME text not null," +
            "FUNCTION_NAME text not null,EXCEPTION text not null);";
        this.AUDIT_ATTEMPTED_IMAGES_TB = "CREATE TABLE AUDIT_ATTEMPTED_IMAGES_TB(ATTEMPTED_ID integer not null," +
...
DataBaseHelper.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_2__["SQLite"] }
];
DataBaseHelper = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
...
let UserLoginService = class UserLoginService {
    ...
    Post_Close_Audit(item) {
        debugger;
        return this.httpClient.post('http://audit.pro-cs.in/Tablez/api/Master/AuditTestHandler.ashx?caller=SaveAudit', item);
        //return this.httpClient.post<SavedAudit >('http://localhost/AuditTablez/api/Master/AuditTestHandler.ashx?caller=SaveAudit', item);
    }
    Post_Question_Image(item) {
        debugger;
        return this.httpClient.post('http://audit.pro-cs.in/Tablez/api/Master/AuditTestHandler.ashx?caller=UploadFile', item);
        //return this.httpClient.post<SavedAudit >('http://localhost/AuditTablez/api/Master/AuditTestHandler.ashx?caller=SaveAudit', item);
    }
};
...
const routes = [
    ...
    {
        path: 'dash-board',
        loadChildren: () => Promise.all(/*! import() | dash-board-dash-board-module */[__webpack_require__.e("common"), __webpack_require__.e("dash-board-dash-board-module")]).then(__webpack_require__.bind(null, /*! ./dash-board/dash-board.module */ "./src/app/dash-board/dash-board.module.ts")).then(m => m.DashBoardPageModule)
    },
    {
        path: 'new-audit',
        loadChildren: () => __webpack_require__.e(/*! import() | new-audit-new-audit-module */ "new-audit-new-audit-module").then(__webpack_require__.bind(null, /*! ./new-audit/new-audit.module */ "./src/app/new-audit/new-audit.module.ts")).then(m => m.NewAuditPageModule)
    },
    {
        path: 'list-audit',
        loadChildren: () => __webpack_require__.e(/*! import() | list-audit-list-audit-module */ "list-audit-list-audit-module").then(__webpack_require__.bind(null, /*! ./list-audit/list-audit.module */ "./src/app/list-audit/list-audit.module.ts")).then(m => m.ListAuditPageModule)
    },
    {
        path: 'close-audit',
        loadChildren: () => Promise.all(/*! import() | close-audit-close-audit-module */[__webpack_require__.e("common"), __webpack_require__.e("close-audit-close-audit-module")]).then(__webpack_require__.bind(null, /*! ./close-audit/close-audit.module */ "./src/app/close-audit/close-audit.module.ts")).then(m => m.CloseAuditPageModule)
    },
    {
        path: 'open-audit',
        loadChildren: () => Promise.all(/*! import() | open-audit-open-audit-module */[__webpack_require__.e("common"), __webpack_require__.e("open-audit-open-audit-module")]).then(__webpack_require__.bind(null, /*! ./open-audit/open-audit.module */ "./src/app/open-audit/open-audit.module.ts")).then(m => m.OpenAuditPageModule)
    },
    {
        path: 'audit-choice-question',
        loadChildren: () => Promise.all(/*! import() | audit-choice-question-audit-choice-question-module */[__webpack_require__.e("common"), __webpack_require__.e("audit-choice-question-audit-choice-question-module")]).then(__webpack_require__.bind(null, /*! ./audit-choice-question/audit-choice-question.module */ "./src/app/audit-choice-question/audit-choice-question.module.ts")).then(m => m.AuditChoiceQuestionPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, modalCtrl, statusBar, network, LoginService, sqlite) {
        this.platform = platform;
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _Service_user_login_service__WEBPACK_IMPORTED_MODULE_6__["UserLoginService"],
...
/* harmony import */ var _Service_user_login_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Service/user-login.service */ "./src/app/Service/user-login.service.ts");
...
/* harmony import */ var _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/sqlite/ngx */ "./node_modules/@ionic-native/sqlite/ngx/index.js");
/* harmony import */ var _Service_DataBaseAdapter__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Service/DataBaseAdapter */ "./src/app/Service/DataBaseAdapter.ts");
/* harmony import */ var _Service_DataBaseHelper__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Service/DataBaseHelper */ "./src/app/Service/DataBaseHelper.ts");
/* harmony import */ var ngx_navigation_with_data__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ngx-navigation-with-data */ "./node_modules/ngx-navigation-with-data/fesm2015/ngx-navigation-with-data.js");
/* harmony import */ var _Service_network_service_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Service/network-service.service */ "./src/app/Service/network-service.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot({ hardwareBackButton: false }), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"]],
        providers: [
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _Service_user_login_service__WEBPACK_IMPORTED_MODULE_10__["UserLoginService"],
            _Service_DataBaseAdapter__WEBPACK_IMPORTED_MODULE_14__["getWritableDatabase"],
            _Service_DataBaseHelper__WEBPACK_IMPORTED_MODULE_15__["DataBaseHelper"],
            ...
            _ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_13__["SQLite"],
            _Service_network_service_service__WEBPACK_IMPORTED_MODULE_17__["NetworkServiceService"],
...
module.exports = __webpack_require__(/*! E:\akshay\ionic\Tablez\src\main.ts */"./src/main.ts");
